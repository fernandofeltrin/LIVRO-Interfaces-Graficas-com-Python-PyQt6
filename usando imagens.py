...
class JanelaPrincipal(QWidget):
    ...
    def salva_dados(self):
        base = []
        base.append(self.caixa_texto1.text()) # Método text irá pegar o texto que foi digitado pelo usuário na caixa de texto, e nesse caso, adicionar a lista base
        base.append(self.caixa_texto2.text())
        print(base) # Apenas para testes, irá exibir o conteúdo de base no terminal, para certificarmos que os dados foram de fato salvos.
